...
def cvtmodule(infile, modulename, moduletype, outfile):
    indent = '  '
    print 'infile: ', infile
    ...
    for line in f:
        ...
        line = line.upper()
        line = line.replace('ALLOCATABLE', 'POINTER')
        ...
        if 'END MODULE' in line or moduletype in line: # and modulename in line:
            inmodule = False
            break
